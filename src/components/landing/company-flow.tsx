...
const CompaniesSec = () => {
  return (
    <section
      className="bg-secondary/40  lg:bg-linear-to-r dark:from-gray-900 dark:via-gray-800 dark:to-gray-900
 px-6 py-20 md:px-10"
    >
      <div className="mx-auto max-w-7xl">
        ...
        <div className="relative overflow-hidden">
          <div className="absolute inset-y-0 left-0 z-10 w-10 bg-linear-to-r from-secondary/40 dark:from-gray-800/40 to-transparent md:w-24" />
          <div className="absolute inset-y-0 right-0 z-10 w-10 bg-linear-to-l from-secondary/40 dark:from-gray-800/40 to-transparent md:w-24" />
