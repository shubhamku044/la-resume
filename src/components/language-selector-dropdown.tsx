...
const LanguageSelectorDropdown = forwardRef<HTMLButtonElement, IProps>(
  ({ showLabel, className }: IProps, ref) => {
...
LanguageSelectorDropdown.displayName = 'LanguageSelectorDropdown';
