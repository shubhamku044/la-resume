...
import { TechProResumeData, techPro, techProResumeSampleData } from './techpro';
...
export type { MTeckResumeData, Sb2novResumeData, deedyResumeData };
...
export const resumesMap = {
  ...
  techpro: {
    ...
    productIdTest: 'pdt_5eCNlkxMaxqNcVHtbLn7X',
