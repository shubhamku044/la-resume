    ...
    <main className="flex min-h-screen items-center justify-center bg-gray-100 p-6">
      <div className="w-full max-w-3xl space-y-6 rounded-2xl bg-white p-8 shadow-xl">
        ...
        <div className="text-center text-gray-700">
          <p>
            Certificate ID:{' '}
            <span className="font-semibold">a4165f27-b692-427d-87a8-3faf7789be2d</span>
          </p>
          <p>
            Issued to: <span className="font-semibold">Priyabrata Mondal</span>
          </p>
          <p>
        ...
        <div className="text-center">
          <a
            href="https://ik.imagekit.io/laresume/certificates/priyabrata-laresume.pdf?updatedAt=1742929264074"
            download
            target="_blank"
