...
export const metadata: Metadata = {
  title: 'Terms & Conditions | La-Resume',
  description: 'The terms and conditions governing your use of La-Resume.',
  alternates: { canonical: 'https://la-resume.com/terms-and-conditions' },
};
  ...
  return (
    <div className="min-h-screen bg-muted px-4 py-12 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-4xl rounded-lg bg-card p-8 shadow-lg">
        <h1 className="mb-8 text-center text-3xl font-bold text-foreground">Terms & Conditions</h1>
        ...
        <div className="prose prose-sm sm:prose-base lg:prose-lg xl:prose-xl mx-auto">
          ...
          <h2 className="mb-4 mt-6 text-xl font-semibold text-foreground">1. Use of Services</h2>
          <p>
          ...
          <h2 className="mb-4 mt-6 text-xl font-semibold text-foreground">3. Unauthorized Use</h2>
          <p>
          ...
          <h2 className="mb-4 mt-6 text-xl font-semibold text-foreground">4. Payment</h2>
          ...
          <h2 className="mb-4 mt-6 text-xl font-semibold text-foreground">6. Third-Party Links</h2>
          <p>
          ...
          <h2 className="mb-4 mt-6 text-xl font-semibold text-foreground">7. Refund Policy</h2>
          <p>
          ...
          <h2 className="mb-4 mt-6 text-xl font-semibold text-foreground">8. Force Majeure</h2>
          <p>
          ...
          <h2 className="mb-4 mt-6 text-xl font-semibold text-foreground">9. Governing Law</h2>
          <p>
          ...
          <h2 className="mb-4 mt-6 text-xl font-semibold text-foreground">10. Jurisdiction</h2>
          <p>
